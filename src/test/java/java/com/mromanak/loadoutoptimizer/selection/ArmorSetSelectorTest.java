...
public class ArmorSetSelectorTest {
    ...
    @Test
    public void constructorShouldThrowExceptionIfSetNamesIsEmpty() {
        exceptionRule.expect(IllegalArgumentException.class);
        exceptionRule.expectMessage("setNames must be non-empty");
        new ArmorSetSelector(ImmutableSet.of(), EXCLUDE);
    }
