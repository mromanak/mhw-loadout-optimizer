...
public class ArmorTypeSelectorTest {
    ...
    @Test
    public void constructorShouldThrowExceptionIfArmorTypesIsEmpty() {
        exceptionRule.expect(IllegalArgumentException.class);
        exceptionRule.expectMessage("armorTypes must be non-empty");
        new ArmorTypeSelector(ImmutableSet.of(), EXCLUDE);
    }
    ...
    public void testShouldReturnFalseIfSetNameMatchesAnyExcludedSetName() {
        ...
        ArmorPiece armorPiece = new ArmorPiece();
        armorPiece.setArmorType(ArmorType.CHARM);
