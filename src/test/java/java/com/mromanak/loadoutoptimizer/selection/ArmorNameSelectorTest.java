...
public class ArmorNameSelectorTest {
    ...
    @Test
    public void constructorShouldThrowExceptionIfPatternsIsEmpty() {
        exceptionRule.expect(IllegalArgumentException.class);
        exceptionRule.expectMessage("patterns must be non-empty");
        new ArmorNameSelector(ImmutableList.of(), EXCLUDE);
    }
